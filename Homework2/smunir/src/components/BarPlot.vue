...
export default {
    mounted() {
        ...
        d3.csv('../../data/groups.csv').then(data => {
            // Parse numeric values
            data.forEach(d => {
                d["successful"] = +d["successful"];
                d["unsuccessful"] = +d["unsuccessful"];
            });
            ...
            data.forEach(d => {
                d.total = d.successful + d.unsuccessful;
            });
            ...
            const margin = { top: 80, right: 30, bottom: 170, left: 180 };
            ...
            svg.append('text')
                ...
                .text('Terrorist attacks by different groups');
            ...
            const legendKeys = ["successful", "unsuccessul"];
