...
function App() {
    ...
    const [dataDetails, setDataDetails] = useState(true);
    const [circleDetails, setCircleDetails] = useState(true);
  ...
  return (
    <div className="App">
        <h1 className={"App-header"}>Information Visualization HW #2</h1>
        <h3>Arisa Cowe</h3>
        <p> In this (React) web-app, we set up a <b>visualization dashboard</b> to visualize data from a csv dataset. </p>
        <br/>
        ...
        <h3><b>Status:</b> {loading ? "Loading..." : "Loaded"} </h3>
