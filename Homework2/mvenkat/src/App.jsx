        ...
        <>
          ...
          <div className="textbox">
            ...
            <p style={{ fontSize: 12, textAlign: "justify" }}>
              ...
              like oxytocin. Research-backed MT practices vary in genre across
              organizations.{" "}
              <strong>
                This dashboard aims to display some correlations that exist
                between an individual's music taste and their self-reported
                mental health. Ideally, these findings could contribute to a
                more informed application of Music Therapy or simply provide
