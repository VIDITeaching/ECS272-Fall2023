...
export default {
    ...
    methods: {
        ...
        initChart() {
            ...
            let yExtents = d3.extent(tgroup.map((d: weight_height) => d.height as number)) as [number, number]
            ...
            let xScale = d3.scaleLinear()
                .range([this.size.width - this.margin.left, this.margin.right]) //bottom side to the top side on the screen
                .domain([60, 0]) // This is based on your data, but if there is a natural value range for your data attribute, you should follow
            ...
            const title = chartContainer.append('g')
                ...
                .text('Average weight-height of Major Type_1 Groups') // text content
        }
    },
    watch: {
        rerender(newSize) {
